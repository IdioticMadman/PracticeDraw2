...
public class Practice12PathEffectView extends View {
...

    {
        ...
        path.rLineTo(70, -120);
        path.rLineTo(150, 80);
        mCornerPathEffect = new CornerPathEffect(30);
        mDiscretePathEffect = new DiscretePathEffect(10, 10);
        mDashPathEffect = new DashPathEffect(new float[]{10, 30}, 0);

        Path dashPath = new Path();
        dashPath.lineTo(20, -30);
        dashPath.lineTo(40, 0);
        dashPath.close();
        mPathDashPathEffect = new PathDashPathEffect(dashPath, 50, 0, PathDashPathEffect.Style.ROTATE);
